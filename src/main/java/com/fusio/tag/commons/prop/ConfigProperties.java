...
public class ConfigProperties {
	private static final ConcurrentHashMap<String, String> props = new ConcurrentHashMap<String, String>();
	...
	public static Properties readProperties(String propFile) {
		...
		try {
			InputStream in = ConfigProperties.class.getResourceAsStream(propFile);
			properties.load(in);
		} catch (Exception e) {
			properties = null;
		}
